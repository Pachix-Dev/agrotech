...
export function ContactForm({name, subject, message, send}){
    ...
    return(
        <>
            <form id='form-contact' className="mt-10 space-y-10"  onSubmit={handleSubmit}>
                <div>
                    ...
                    <>
                      {
                        ...
                        ?
                            <button
                            type="submit"
                            className="text-white bg-agro-green hover:bg-blue-700 focus:ring-4 focus:outline-none 
